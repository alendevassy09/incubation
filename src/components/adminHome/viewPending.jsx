   ...
   useEffect(()=>{
    if(!localStorage.getItem('AdminEmail')){
        ...
        useEffect(()=>{
                ...
                axios.get('http://localhost:3000/viewPending',{params:{id:localStorage.getItem('new')}}).then((response)=>{
    ...
    <div>
            ...
            <div className="container">
                ...
                <div className="col-3 bg-light text-center">
                        <button style={{visibility}} onClick={()=>approve(data._id)}  className='btn btn-danger'>Approve</button>
                    </div>
                </div>
                </div>
        </div>
